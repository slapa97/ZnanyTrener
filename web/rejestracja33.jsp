      ...
      <main class="page-content">
          ...
          <div class="shell">
            ...
            <div class="range range-xs-center offset-top-66">
              <div class="cell-lg-8">
                  <p> <h4 class="text-danger offset-top-20">Chcąc założyc konto w systemie podaj adres E-mail</h4></p>

              
                           <div class='error'>
                 <p>*** Nie można założyć konta w systemie na podany adres E-mail ***</p>
                        </div>
                <form class=" text-left offset-top-50" action="rejestracja2" method="POST" onsubmit="return przetwarzajj_dane()">
                  <div class="range">
