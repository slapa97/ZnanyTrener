...
<li><a href="a_opinie"><span>Zarządzaj opiniami</span></a></li>
...
<li ><a  href="logaut"><span>Wyloguj</span></a></li>                          
      ...
      <main class="page-content">
          ...
          <div class="shell">
              ...
              <div id="r"><font color="blue"><%= session.getAttribute("imie") %> <%= session.getAttribute("nazwisko") %></font> - ADMIN - zalogowany</div><br>
        
            <hr class="divider bg-red">
            <div class="range range-xs-center offset-top-66">
              <div class="cell-lg-8">
                  <p> <h4 class="text-danger offset-top-20">Administrator zalogowany w systemie</h4></p>
