...
<li><a href="p_rezerwacje?id_user=<%= session.getAttribute("id_user") %>"><span>Moje zapisy</span></a></li>
<li><a href="p_szukaj?id_user=<%= session.getAttribute("id_user") %>"><span> Szukaj trenera</span></a></li>
<li><a href="p_zmiana?id_user=<%= session.getAttribute("id_user") %>"><span> Zmiana hasła</span></a></li>                  
<li ><a  href="logaut"><span>Wyloguj</span></a></li>                          
      ...
      <main class="page-content">
          ...
          <div class="shell">
              ...
              <div id="r"><font color="blue"><%= session.getAttribute("imie") %> <%= session.getAttribute("nazwisko") %></font> - KLIENT - zalogowany</div><br>

            <hr class="divider bg-red">
            <div class="range range-xs-center offset-top-66">
              <div class="cell-lg-8">
                  <p> <h4 class="text-danger offset-top-20">KLIENT zalogowany w systemie</h4></p>
