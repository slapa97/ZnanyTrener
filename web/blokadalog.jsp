...
<li class="active"><a href="logowanie2.jsp"><span>Panel trenera</span></a></li> 
      ...
      <main class="page-content">
          ...
          <div class="shell">
            <h1>Logowanie / Trener</h1>
            <hr class="divider bg-red">
            <div class="range range-xs-center offset-top-66">
              <div class="cell-lg-8">
                  <p> <h4 class="text-danger offset-top-20">W celu uzyskania dostępu do serwisu podaj adres email i hasło</h4></p>

                       <div class='error'>
                 <p>*** Konto dla adresu E-mail <b> <%= session.getAttribute("email") %> </b> zostało zablokowane***</p>
                        </div>
              
                <form class=" text-left offset-top-50" action="logowanie" method="POST" onsubmit="return przetwarzajj_dane()">
                  <div class="range">
              ...
              <div id="r"><a href="rejestracja2.jsp" class="btn btn-default">Rejestracja nowego konta</a></div><br>
