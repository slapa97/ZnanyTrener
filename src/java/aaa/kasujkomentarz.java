 ...
 * @author aaaaa
 */
@WebServlet(name="kasujkomentarz", urlPatterns={"/kasujkomentarz"})
public class kasujkomentarz extends HttpServlet {
...
String id_komentarz= request.getParameter("id_komentarz");
        ...
        try
        {
         ...
         sql.executeUpdate("delete from komentarz where id_komentarz='"+id_komentarz+"';");

        response.sendRedirect("a_opinie");
