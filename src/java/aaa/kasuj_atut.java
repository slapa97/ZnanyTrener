 ...
 * @author aaaaa
 */
@WebServlet(name="kasuj_atut", urlPatterns={"/kasuj_atut"})
public class kasuj_atut extends HttpServlet {
...
String id_atut= request.getParameter("id_atut");
        ...
        try
        {
         ...
         sql.executeUpdate("delete from atuty where id_atuty='"+id_atut+"';");
